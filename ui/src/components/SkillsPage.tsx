  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "SQL", level: 88, icon: "🗄️", color: "from-blue-400 to-blue-600" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "SVN", level: 80, icon: "📦", color: "from-gray-500 to-gray-700" },
        { name: "Jira", level: 85, icon: "🎯", color: "from-blue-600 to-blue-800" }
      ]
    },
    {
      title: "AI & ML",
      skills: [
        ...
        { name: "LangChain", level: 80, icon: "🔗", color: "from-green-500 to-blue-500" },
        { name: "OpenAI API", level: 82, icon: "🤖", color: "from-green-500 to-blue-500" },
        { name: "Cursor", level: 78, icon: "✏️", color: "from-blue-500 to-purple-500" },
        { name: "Prompt Engineering", level: 75, icon: "💭", color: "from-yellow-400 to-orange-500" }
      ]
    },
    {
      title: "Monitoring & DevOps",
      skills: [
        { name: "New Relic", level: 90, icon: "📊", color: "from-orange-500 to-red-500" },
        { name: "Splunk", level: 85, icon: "🔍", color: "from-orange-400 to-yellow-500" },
        { name: "Jenkins", level: 80, icon: "🤖", color: "from-red-500 to-orange-500" },
        { name: "TeamCity", level: 75, icon: "🏗️", color: "from-blue-500 to-blue-700" },
        { name: "GCP", level: 70, icon: "☁️", color: "from-blue-400 to-blue-600" }
      ]
    }
  ];
