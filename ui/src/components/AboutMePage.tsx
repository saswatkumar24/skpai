  ...
  const achievements = [
    {
      ...
      description: "Recognized for outstanding contribution to AI-powered applications",
      year: "2023",
      icon: "🏆"
    },
    {
    ...
    },
    {
      ...
      description: "Presented at major tech conferences on AI and web development",
      year: "2021",
      icon: "🎤"
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-800 mb-6 leading-relaxed">
                I'm a Senior Tech Lead with over 9 years of experience in application development, 
                automation, and database management. I specialize in Perl programming, shell scripting, 
                and automation tools, with recent expansion into AI/ML technologies.
              </p>
              <p className="text-lg text-gray-800 mb-6 leading-relaxed">
                My journey in tech started with email marketing analytics and has evolved through 
                database management, automation, and now AI/ML. I've worked with major clients like 
                Deutsche Bank, Mastercard, Humana Inc., and Zeta Global. I'm passionate about 
                automation, problem-solving, and continuous learning.
              </p>
